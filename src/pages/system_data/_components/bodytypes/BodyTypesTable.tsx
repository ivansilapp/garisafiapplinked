...
import BodyTypeTableRow from './BodyTypeTableRow'
...
function BodyTypesTable({ data, handleUpdate, mutate }: any) {
    const {
        dense,
        page,
        order,
    ...
    const handleDeleteRow = async (id: any) => {
        try {
            ...
            const url = `/body-type/${id}`
            const response = await axios.delete(url)
            if (!response.data) {
                throw new Error('Error deleting body type')
            }
            ...
            enqueueSnackbar('Body type deleted', { variant: 'success' })
        } catch (err: any) {
            // console.log(err)
