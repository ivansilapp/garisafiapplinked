...
const TABLE_HEAD = [
    ...
    { id: 'amount_not_paid', label: 'Not paid', align: 'left' },
    { id: 'more', label: 'More', align: 'left' },
    // { id: '' },
]

function GroupedCommissionTable({ data }: any) {
    const {
        dense,
        page,
        order,
                    ...
                    >
                        ...
                        <TableBody>
                            {dataFiltered
                                ...
                                .map((row: any) => (
                                    <CommissionsGroupedTableRow
                                        key={row.attendantName + row.date}
                                        row={row}
...
export default GroupedCommissionTable
